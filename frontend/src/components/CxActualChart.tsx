...
import type { CxActualSummaryResponse, CxActualWeek, CxActualSite } from "@/lib/types";
...
export default function CxActualChart({
  ...
  function weekKey(w: CxActualWeek) {
  ...
  return (
    <div className="h-full overflow-auto p-5 space-y-5">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-5 py-3 flex flex-col items-center">
          <span className="text-2xl font-bold text-teal-600">{data.total_weeks}</span>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        <h3 className="text-sm font-semibold text-gray-700 mb-4">
          CX Actual — Weekly Site Counts (Actual Construction Start)
        </h3>
